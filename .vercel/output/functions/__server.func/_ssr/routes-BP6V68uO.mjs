...
import { a as useCurrentUserState, r as LoginScreen, t as AuthSkeleton } from "./login-screen-QyTzvYC2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BP6V68uO.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var QrStudio = (0, import_react.lazy)(async () => {
	return { default: (await import("./studio-BgPnINBp.mjs")).QrStudio };
});
function Home() {
